...
class Kunh:
    ...
    def is_terminal(history, config):
        ...
        elif in_river and history[history.rfind('R') +1:history.rfind(' ')].count('1') == 3:
        ...
        elif in_river and history[history.rfind('R') +1:history.rfind(' ')].count('1') == 2:
    ...
    def start_turn(history):
        if 'T' not in history and len(history[history.rfind(' ') + 1:]) > 2:
            if history[-3:] == 'ppp' or history[-3:] == 'bcc' or history[-3:] == 'bcp' or history[-3:] == 'bpc':return True
            if history[-4:] == 'bpbc':return True
        return False
    @staticmethod
    def start_river(history):
        if 'R' not in history and len(history[history.rfind(' ') + 1:]) > 2:
            if history[-3:] == 'ppp' or history[-3:] == 'bcc' or history[-3:] == 'bcp' or history[-3:] == 'bpc':return True
            if history[-4:] == 'bpbc':return True
        return False
